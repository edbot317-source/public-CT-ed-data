# District-year four-year graduation rates

- **Series name:** District-year four-year graduation rates
- **Grain:** one row per district x fiscal_year x needs_group
- **Year range:** FY2012-FY2025
- **Source:** EdSight Graduation; https://edsight.ct.gov/SASStoredProcess/do?_program=/CTDOE/EdSight/Release/Reporting/Public/Reports/StoredProcesses/GraduationReport_SiteCore&_rpttype=listing&_year={YYYY-YY}&_district=All+Districts&_subgroup={subgroup}&_school=&_select=Submit
- **Row count:** 5,839
- **Column count:** 6
